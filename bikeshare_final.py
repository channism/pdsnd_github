...
def get_filters():
    ...
    Returns:
        ...
        (str) month - name of the month filtered by, or "all" to apply no month filter
        (str) day - name of the day of week filtered by, or "all" to apply no day filter
    """
...
def load_data(city, month, day):
    ...
    # To do : extract month and day of week and hour from Start Time to create new columns
...
def trip_duration_stats(df):
    ...
    # To do : display the total trip duration for each user type
...
def user_stats(df):
    ...
    # To do : iteratively print out the total numbers of user types 
...
def user_stats_birth(df):
    ...
    # To do : the most common birth year
    most_common_year = birth_year.value_counts().idxmax()
    print("The most common birth year:", most_common_year)
    # To do : the most recent birth year
    most_recent = birth_year.max()
    print("The most recent birth year:", most_recent)
    # To do : the most earliest birth year
...
def table_stats(df, city):
    ...
    # To do : counts the number of missing values in the entire dataset
    ...
    # To do : counts the number of missing values in the User Type column
...
def display_data(df):
    ...
    # To do : iterate from 0 to the number of rows in steps of 5
    for i in range(0, row_length, 5):
        ...
        # To do : retrieve and convert data to json format
        # To do : split each json row data 
